...
- **Empreinte :** `b5a469d3603c187e`
- **Générée :** 2026-07-24T11:34:07.066Z
- **Git informatif :** branche `main`, HEAD `7b810cb23d47`, 12 entrée(s) dans le worktree
...
| --- | --- | --- | --- |
| Règles et boucle | `6a03c006eb34` | `AGENTS.md`<br>`.agents/skills/conduire-boucle-fantasy-story/SKILL.md`<br>`artifacts/loops/006-jouer-sur-mobile.md` | validateur du skill, puis `git diff --check` |
...
| Application et interface | `61b718f25286` | `src/main.js`<br>`src/preload.js`<br>`src/renderer/app.js`<br>`src/renderer/styles.css` | `npm run qa:visual` si le rendu ou l'interaction change |
...
| Configuration et reste du projet | `2c759e3c13fe` | `package.json`<br>`README.md`<br>`.gitignore` | validation dictée par le domaine concerné |
