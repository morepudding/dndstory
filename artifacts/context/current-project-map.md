...
- **Empreinte :** `b8eb2fc4731b0bd8`
- **Générée :** 2026-07-24T14:09:41.439Z
- **Git informatif :** branche `main`, HEAD `fd680de8694e`, 14 entrée(s) dans le worktree
...
| --- | --- | --- | --- |
| Règles et boucle | `85f3658d7d94` | `AGENTS.md`<br>`.agents/skills/conduire-boucle-fantasy-story/SKILL.md`<br>`artifacts/loops/006-jouer-sur-mobile.md` | validateur du skill, puis `git diff --check` |
...
| Application et interface | `44ef51ea256e` | `src/main.js`<br>`src/preload.js`<br>`src/renderer/app.js`<br>`src/renderer/styles.css` | `npm run qa:visual` si le rendu ou l'interaction change |
...
| Configuration et reste du projet | `76032031b86e` | `package.json`<br>`README.md`<br>`.gitignore` | validation dictée par le domaine concerné |
