...
- **Empreinte :** `e6b6ba47ade88212`
- **Générée :** 2026-07-24T11:01:21.111Z
- **Git informatif :** branche `main`, HEAD `d45532b212d9`, 36 entrée(s) dans le worktree
...
| --- | --- | --- | --- |
| Règles et boucle | `51a9a3c55d53` | `AGENTS.md`<br>`.agents/skills/conduire-boucle-fantasy-story/SKILL.md`<br>`artifacts/loops/006-jouer-sur-mobile.md` | validateur du skill, puis `git diff --check` |
...
| Application et interface | `f865dc79a84e` | `src/main.js`<br>`src/preload.js`<br>`src/renderer/app.js`<br>`src/renderer/styles.css` | `npm run qa:visual` si le rendu ou l'interaction change |
...
| Configuration et reste du projet | `fbd8c0d106ca` | `package.json`<br>`README.md`<br>`.gitignore` | validation dictée par le domaine concerné |
